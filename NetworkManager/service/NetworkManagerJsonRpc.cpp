...
#define LOGINFOMETHOD() { std::string json; parameters.ToString(json); NMLOG_TRACE("JSONRPC params=%s", json.c_str() ); }
#define LOGTRACEMETHODFIN() { std::string json; response.ToString(json); NMLOG_TRACE("JSONRPC response=%s", json.c_str() ); }
