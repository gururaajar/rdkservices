...
#define LOGINFOMETHODEVENTS() { std::string json; params.ToString(json); NMLOG_TRACE("NM events params=%s", json.c_str() ); }
#define LOGINFOMETHODLEGEVENTS() { std::string json; legacyParams.ToString(json); NMLOG_TRACE("Legacy events params=%s", json.c_str() ); }
